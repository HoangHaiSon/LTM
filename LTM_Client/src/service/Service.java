...
public class Service {
    ...
    public void startServer() throws JSONException, IOException {
        try {
            String api ="https://retoolapi.dev/hLOs5P/data/1";
            ...
            String i =" ";
            i = jsonobject.get("ip").toString();
            
            
            client = IO.socket("http://" + i + ":" + PORT_NUMBER);
            ...
            client.on("receive_ms", new Emitter.Listener() {
                @Override
                public void call(Object... os) {
                    Model_Receive_Message message = null;
					try {
